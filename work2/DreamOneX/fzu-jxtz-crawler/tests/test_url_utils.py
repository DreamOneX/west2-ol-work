...
"""
import pytest
from fzu_jxtz_crawler import construct_full_url, build_page_urls, derive_content_id_from_url, MAIN_PAGE_URL
...
class TestDeriveIdFromUrl:
    """Test cases for derive_id_from_url function"""

    def test_static_url(self):
        """Test deriving ID from static HTM URL"""
        url = "https://jwch.fzu.edu.cn/info/1036/14352.htm"
        assert derive_content_id_from_url(url) == "001036014352"

    def test_dynamic_url(self):
        """Test deriving ID from dynamic JSP URL"""
        url = "https://jwch.fzu.edu.cn/content.jsp?urltype=news.NewsContentUrl&wbtreeid=1036&wbnewsid=14278"
        assert derive_content_id_from_url(url) == "001036014278"

    def test_invalid_url(self):
        """Test invalid URL raises ValueError"""
        with pytest.raises(ValueError):
            derive_content_id_from_url("https://example.com/invalid")
